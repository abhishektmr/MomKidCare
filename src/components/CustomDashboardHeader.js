...
export default function CustomDashboardHeader() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.textInputAndSearchContainer]}>
        {
          searchIconClicked ?
          <View style={{flex: 1}}>
          ...
          <View style={styles.searchIconContainer}>
            <TouchableOpacity onPress={() => setSearchIconClicked(true)}>
              <MaterialIcons name="search" size={28} color={theme.iconColor} />
            </TouchableOpacity> 
          </View>
        }
      </View>
      ...
      <View style={styles.profileIconContainer}>
        <TouchableOpacity onPress={() => navigation.navigate('Profile')}>
          <MaterialCommunityIcons name="face-woman-outline" size={28} color={theme.iconColor} />
        </TouchableOpacity> 
      </View>
